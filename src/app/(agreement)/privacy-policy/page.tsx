...
export const metadata: Metadata = {
  ...
  description: "Posltack | Privacy Policy",
};
...
function PrivacyPage() {
  return (
    <div className="prose lg:prose-lg mx-auto h-screen max-w-screen-md p-4 py-12">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Polstack.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Polstack, accessible from{" "}
            <a
              href="https://poltek-stack.com"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://poltek-stack.com
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: support@polstack.com</li>
      </ul>
    </div>
  );
}
